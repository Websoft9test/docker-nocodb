...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r nocodb
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r nocodb -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-nocodb
cd docker-nocodb
docker-compose  up -d
```
...
| --- | --- | --- | --- |
| Nocodb | 9001 | Access to Nocodb by HTTP | Y |
## Documentation

[Nocodb Administrator Guide](https://support.websoft9.com/docs/nocodb)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Nocodb Enterprise Support](https://apps.websoft9.com/nocodb) 
